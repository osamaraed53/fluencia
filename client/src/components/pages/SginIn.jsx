            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <div>
                ...
                <div className="flex flex-col -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button className="block w-full max-w-xs mx-auto bg-fluencia-yellow-first hover:bg-fluencia-yellow-second focus:bg-fluencia-yellow-second text-white rounded-lg px-3 py-3 font-semibold">
                      Sign In
                    </button>
                  </div>
