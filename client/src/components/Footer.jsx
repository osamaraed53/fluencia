    ...
    <footer class="bg-fluencia-dark-purple  ">
      <div class="md:px-16 px-4 pb-6 pt-10 sm:px-6  lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div class="flex justify-center text-fluencia-purple sm:justify-start">
              <a href="/" className="flex items-center">
                <img
                  src={logo}
                  className="lg:h-20 lg:w-20 h-14 w-14 p-0 md:h-20 md:w-20 "
                  alt="Logo"
                />
              </a>
            </div>
          ...
          <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            <div class="text-center sm:text-left">
              <p class="text-lg font-medium text-fluencia-blue">About Us</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg font-medium text-fluencia-blue">Our Services</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg font-medium text-fluencia-blue">Helpful Links</p>
            ...
            <div class="text-center sm:text-left">
              <p class="text-lg font-medium text-fluencia-blue">Contact Us</p>
