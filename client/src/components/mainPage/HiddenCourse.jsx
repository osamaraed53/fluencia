...
const HiddenCourse = ({ hiddenCourses, flag, setFlag }) => {
              ...
              .map((course) => (
                <li className="border rounded-lg opacity-40">
                  <div className="flex items-start justify-between p-4">
                    ...
                    <button
                      onClick={() => {
                        activateCourse(course.course_id);
                      }}
        ...
        <div className="px-5 py-5 bg-white flex flex-col xs:flex-row items-center xs:justify-between          ">
          <div className="inline-flex mt-2 xs:mt-0">
            ...
            <button
              ...
              disabled={hiddenCourses.length - 1 < canClickNext.current}
              className={`text-sm text-white transition duration-150 ${
                hiddenCourses.length - 1 < canClickNext.current
                  ? "bg-gray-300"
                  : "hover:bg-fluencia-yellow-second bg-fluencia-yellow-first"
