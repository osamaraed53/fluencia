...
// <>
//   {/* component */}
//   <section className="bg-white dark:bg-gray-800 mx-20 border-b-2">
  
//     <div className="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
//       <div className="w-full lg:w-1/2">
//         <div className="lg:max-w-lg">
//           <h1 className="text-3xl font-bold tracking-wide text-gray-800 dark:text-white lg:text-5xl text-left">
//           Language learning platform with courses.
//           </h1>
...
//      {/* component */}
//      <div className="w-full my-20 z-50 sticky  rounded-3xl px-6 ">
//        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
//          <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
//            <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
//             <div className="max-w-xl mb-6">
//                    <h2 className="font-sans text-3xl font-bold tracking-tight text- sm:text-4xl sm:leading-none max-w-lg mb-6">
//                Lorem Ipsum Is Cool.
//                </h2>
...
//               <a className="flex object-cover sm:mr-64 mr-32 object-top items-center text-black border border-2 justify-center w-full sm:px-10 py-4 leading-6 bg-white rounded-lg font-black">
//                 &nbsp;&nbsp;
//                 <img
//                   alt="logo"
//                   width={25}
...
//               <link href="/comingsoon" />
//               <a className="flex hover:border-2 hover:shadow-xl items-center text-white border border-2 justify-center w-full sm:px-10 py-4 leading-6 bg-white rounded-lg font-black">
//                 &nbsp;&nbsp;
//                 <img
//                   width={25}
//                   alt="gmail logo"
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="group relative mt-10 inline-flex">
          <a
            href="#"
            title=""
            className="rounded-xl bg-fluencia-dark-purple px-10 py-3 font-medium text-white transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-fluencia-purple focus:ring-offset-2 hover:bg-fluencia-purple"
          >
            services
          </a>
          <div className="-scale-x-100 absolute left-0 -bottom-10 hidden h-10 w-10 -rotate-12 text-fluencia-dark-purple md:inline-flex">
            <svg
              viewBox="0 0 82 35"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
