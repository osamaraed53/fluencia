...
import {fetchActiveCourses ,softDeleteCourse} from '../ReduxSlice/courseSlice'
  ...
  // for pagination 
    ...
    <>
        ...
        <div className="items-start justify-between sm:flex">
            <div>
                <h4 className="text-gray-800 text-xl font-semibold">All Courses</h4>
            ...
            {courses.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map(course => (
              <li className="border rounded-lg ">
                <div className="flex items-start justify-between p-4">
                  ...
                  <button
                  onClick={()=>{hiddenCourse(course.course_id)}}
