        ...
        <ul className="mt-4 divide-y space-y-3">
            {
                tasks.map((task, idx) => (
                    <li key={idx} className="px-4 py-5 duration-150 bg-fluencia-light-purple hover:border-white rounded-xl hover:bg-fluencia-purple">
                        <a href={task.path} className="space-y-3">
                            <div className="flex items-center gap-x-3">
                                <div>
                                    <h2 className="text-base text-white font-bold mt-1">{task.job_title}</h2>
                                </div>
                            </div>
                            ...
                            <div className="text-sm text-white flex justify-between gap-6">
                                ...
                                <a href="javascript:void(0)" className="text-gray-700 text-sm border rounded-lg px-3 py-2 duration-150 bg-fluencia-yellow-first hover:bg-fluencia-yellow-first  justify-self-">Details</a>
                            </div>
                        </a>
                    </li>
                ))
